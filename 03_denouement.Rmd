...
```{r}
co_water_data <- function(site, start_wateryear, end_wateryear) {
  raw_data<- GET(url = paste0("https://dwr.state.co.us/Rest/GET/api/v2/surfacewater/","surfacewatertsday/?format=json&dateFormat=dateOnly&fields", "=abbrev%2CmeasDate%2Cvalue%2CmeasUnit&encoding=deflate&abbrev=", site, "&min-measDate=10%2F01%2F", start_wateryear -1 , "2020&max-measDate=09%2F30%2F", end_wateryear ))
}
```
